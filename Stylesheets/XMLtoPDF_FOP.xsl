...
<xsl:template name="Titel">
	...
	<fo:block-container absolute-position="absolute"
		...
		<fo:block>
			<fo:external-graphic content-width="{$Skalierung_Logo_Titel}" src="{$SharedImagesPfad}/HTWK_Logo.jpg"/>
		</fo:block>
	</fo:block-container>
</xsl:template>
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell column-number="1">
							<fo:block>
								<fo:external-graphic content-width="{$Skalierung_CC-Hinweis}" src="{$SharedImagesPfad}/CC_Hinweis.jpg"/>
							</fo:block>
						</fo:table-cell>
